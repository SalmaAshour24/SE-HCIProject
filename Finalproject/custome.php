...
<!------------form------------------->
<section>
<h1 style="  font-weight: bold; color:97B73F;" >1) Insert any design you want : </h1><br>
...
<section>
<h1 style="  font-weight: bold; color:97B73F;" >2) Fill the form :</h1>
...
<select class="category" id="meeting" name="meeting" style="margin-left:-50px;">
    ...
    <!------------calenderr------------------->
<section>
<h1 style="  font-weight: bold; color:97B73F;" >3) Reserve a meeting date :</h1><br>
<input type="datetime-local" id="datetime" name="datetime" value="06/22/2021 06:14"><br><br>
</section>
            <!------------calenderr------------------->
<section>
<h1 style="  font-weight: bold; color:97B73F;" >4) Insert any extra picture: </h1>
<div class="container" style="border-style: solid;   padding-bottom:90px; margin-bottom:90px; padding-top:20px;">
<input type="file" name="image" class="chooseimage ">
</div>        
</section>
<input style="margin-left:400px;" name="Submit" type="submit" class="button" value="Submit">
        ...
        if(isset($_POST['Submit']))
        {
            ...
            $check=new checkout();
            $check->fillformC($_POST["width"],$_POST["Height"],$_POST["Add"],$_POST["pool"],$_POST["barb"],$_POST["karea"],$_POST["kgarden"],$_POST["IN"],$_POST["light"],$_POST["meeting"],$_POST["datetime"],$image);
        }
